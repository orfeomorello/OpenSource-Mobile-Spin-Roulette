...
## Release notes — first production release (max 500 · 37 used)

Play Console → **Release → Production** (or testing track) → Release notes for Chinese (Simplified).

```
首次登陆 Play 商店。免费欧式与美式轮盘，仅虚拟积分。无广告、无内购。
```
...
```
https://mobilespinroulette.pages.dev/privacy/zh.html
```
