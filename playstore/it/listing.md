...
Play Console → **Release → Production** (or testing track) → Release notes for Italian.

```
Prima pubblicazione su Play Store. Roulette europea e americana gratis, solo punti virtuali. Niente ads e niente acquisti.
```
...
```
https://mobilespinroulette.pages.dev/privacy/it.html
```
