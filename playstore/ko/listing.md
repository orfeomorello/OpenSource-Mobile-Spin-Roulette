...
## Release notes — first production release (max 500 · 50 used)

Play Console → **Release → Production** (or testing track) → Release notes for Korean.

```
플레이 스토어 첫 출시. 유럽식·미국식 룰렛, 가상 점수만. 광고 없음, 인앱 결제 없음.
```
...
```
https://mobilespinroulette.pages.dev/privacy/ko.html
```
