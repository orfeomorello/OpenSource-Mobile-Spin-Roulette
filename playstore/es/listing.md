...
## Release notes — first production release (max 500 · 117 used)

Play Console → **Release → Production** (or testing track) → Release notes for Spanish (Spain).

```
Primera publicación en Play Store. Ruleta europea y americana gratis, solo puntos virtuales. Sin anuncios ni compras.
```
...
```
https://mobilespinroulette.pages.dev/privacy/es.html
```
