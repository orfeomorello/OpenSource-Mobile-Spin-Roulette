...
## Release notes — first production release (max 500 · 43 used)

Play Console → **Release → Production** (or testing track) → Release notes for Japanese.

```
Playストア初公開。欧州式・米国式ルーレット。仮想ポイントのみ。広告なし、購入なし。
```
...
```
https://mobilespinroulette.pages.dev/privacy/ja.html
```
